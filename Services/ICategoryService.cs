...
public class CategoryService : ICategoryService
{
    ...
    {
        return await _context.Categories.Where(c => c.MenuId == menuId).Include(c => c.FoodItems).ToListAsync();
    }

    public async Task<Category> GetCategory(int id)
    {
        return await _context.Categories.Include(c => c.FoodItems).FirstOrDefaultAsync(c => c.Id == id);
    }
